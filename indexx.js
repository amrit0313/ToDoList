...
alert(
  "Enter the task you want to do, Every task have a + button, click on it and add subtask to each"
);
...
let completed = document.getElementById("container-completed");

drop_down.addEventListener("click", function (event) {
